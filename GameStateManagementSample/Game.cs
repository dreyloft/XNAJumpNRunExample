...
namespace Ratatöskrs_Great_Adventure
{
    ...
    /// </summary>
    public class Ratatöskrs_Great_AdventureGame : Microsoft.Xna.Framework.Game
    {
        #region Fields
        ...
        /// </summary>
        public Ratatöskrs_Great_AdventureGame()
        {
    ...
    static class Program
    {
        static void Main()
        {
            using (Ratatöskrs_Great_AdventureGame game = new Ratatöskrs_Great_AdventureGame())
            {
                game.Run();
            }
        }
